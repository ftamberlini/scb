    ...
    if ingresso_files:
        ...
        con.execute(f"""
            ...
            SELECT
                ...
                TRY_CAST(i.ANO_CINEMATOGRAFICO AS INTEGER) AS ANO_CINEMATOGRAFICO,
                ...
                i.QT_PUBLICO_PAGANTE AS PUBLICO_PAGANTE,
                i.VL_RENDA_TOTAL AS RENDA_TOTAL,
                -- Tipo de ingresso: TOTAL = INTEIRA + MEIA + PROMOCIONAL + CORTESIA
                -- (PAGANTE = INTEIRA + MEIA + PROMOCIONAL, ou seja, TOTAL menos CORTESIA).
                i.QT_PUBLICO_INTEIRA AS PUBLICO_INTEIRA,
                i.QT_PUBLICO_M_ENTRADA AS PUBLICO_MEIA,
                i.QT_PUBLICO_PROMOCIONAL AS PUBLICO_PROMOCIONAL,
                i.QT_PUBLICO_CORTESIA AS PUBLICO_CORTESIA,
                i.VL_RENDA_INTEIRA AS RENDA_INTEIRA,
                i.VL_RENDA_M_ENTRADA AS RENDA_MEIA,
                i.VL_RENDA_PROMOCIONAL AS RENDA_PROMOCIONAL,
                i.VL_RENDA_CORTESIA AS RENDA_CORTESIA,
